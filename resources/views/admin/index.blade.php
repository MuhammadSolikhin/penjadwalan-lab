...
@section('content')
    ...
    <div class="d-flex m-4">
        <div class="col d-flex flex-column justify-content-center align-items-center bg-white rounded me-2 p-4">
            ...
            <div class="position-relative" style="width: 150px">
                ...
                <p class="position-absolute fw-bold fs-3 text-center" style="top: 58px; left: 52px">566</p>
            </div>
    ...
    {{-- Submission Table --}}
    <div class="bg-white rounded-3 m-4">
        <h6 class="fs-4 fw-medium mb-4 mybg-brown200 p-3 rounded-top-2">Tabel Pengajuan</h6>
