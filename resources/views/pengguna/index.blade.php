...
@section('content')
    ...
    <div class="row m-4 gap-3">
        <div class="col-12 col-lg bg-white rounded me-2 px-4 pt-4">
        ...
        {{-- Submission Table --}}
        <div class="col-12 col-lg bg-white rounded-3 p-0 m-0">
            <h6 class="fs-4 fw-medium mybg-brown100 rounded-top-3 w-100 p-3">Status Pengajuan</h6>
